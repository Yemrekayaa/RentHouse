...
namespace RentHouse.Persistence.Migrations
{
    ...
    [Migration("20241118162808_add_housepricing2")]
    partial class add_housepricing2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RentHouse.Domain.Entities.HousePricing", b =>
                {
                    b.Property<int>("HousePricingID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("HousePricingID"));
                    ...
                    b.HasKey("HousePricingID");

                    b.HasIndex("HouseID");

                    b.HasIndex("PricingID");

                    b.ToTable("HousePricings");
                });
            ...
            modelBuilder.Entity("RentHouse.Domain.Entities.HousePricing", b =>
                {
                    b.HasOne("RentHouse.Domain.Entities.House", "House")
                        .WithMany("HousePricings")
                        .HasForeignKey("HouseID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RentHouse.Domain.Entities.Pricing", "Pricing")
                        .WithMany()
